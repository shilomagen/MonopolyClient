...
public interface MonopolyWebService {
     ...
     * @param playerId
     * @return
     *     returns java.util.List<com.monopoly.client.ws.Event>
     * @throws InvalidParameters_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getEvents", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetEvents")
    @ResponseWrapper(localName = "getEventsResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetEventsResponse")
     ...
     * @param gameName
     * @return
     *     returns java.util.List<com.monopoly.client.ws.PlayerDetails>
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayersDetails", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetPlayersDetails")
    @ResponseWrapper(localName = "getPlayersDetailsResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetPlayersDetailsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getWaitingGames", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetWaitingGames")
    @ResponseWrapper(localName = "getWaitingGamesResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetWaitingGamesResponse")
    ...
    @ResponseWrapper(localName = "createGameResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.CreateGameResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "resign", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.Resign")
    @ResponseWrapper(localName = "resignResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.ResignResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "joinGame", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.JoinGame")
    @ResponseWrapper(localName = "joinGameResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.JoinGameResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getBoardXML", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetBoardXML")
    @ResponseWrapper(localName = "getBoardXMLResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetBoardXMLResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayerDetails", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetPlayerDetails")
    @ResponseWrapper(localName = "getPlayerDetailsResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetPlayerDetailsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getBoardSchema", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetBoardSchema")
    @ResponseWrapper(localName = "getBoardSchemaResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetBoardSchemaResponse")
     ...
     * @param gameName
     * @return
     *     returns com.monopoly.client.ws.GameDetails
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getGameDetails", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetGameDetails")
    @ResponseWrapper(localName = "getGameDetailsResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.GetGameDetailsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "buy", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.Buy")
    @ResponseWrapper(localName = "buyResponse", targetNamespace = "http://monopoly.ws/", className = "com.monopoly.client.ws.BuyResponse")
